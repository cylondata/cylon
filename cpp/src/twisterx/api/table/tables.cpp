...
twisterx::Status twisterx::api::table::read_csv(const std::string &path, const std::string &id) {
...
twisterx::Status twisterx::api::table::show(const std::string &table_id, int col1, int col2, int row1, int row2) {
...
twisterx::Status twisterx::api::table::joinTables(const std::string &table_left,
...
int twisterx::api::table::column_count(const std::string &id) {
...
int twisterx::api::table::row_count(const std::string &id) {
    auto table = get_table(id);
    if (table != NULLPTR) {
...
twisterx::Status twisterx::api::table::merge(std::vector<std::string> table_ids, const std::string &merged_tab) {
