...
static constexpr const char *kDefaultIndexName = "index";
...
Status Table::SetArrowIndex(int col_id, IndexingType indexing_type) {
  return BuildIndex(this, col_id, indexing_type, &base_arrow_index_);
}
