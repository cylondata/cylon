...
combination = [\
    ...
    ("54.84.214.80", 8,8, 16, args['rows'], "parallel", ""),
    ("3.238.116.229", 8,8, 16, args['rows'], "parallel", ""),
    ("54.157.181.17", 8,8, 16, args['rows'], "parallel", ""),
    ("34.228.29.43", 8,8, 16, args['rows'], "parallel", ""),
