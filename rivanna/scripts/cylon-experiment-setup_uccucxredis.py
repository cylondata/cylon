...
combination = [\
    ...
    ("3.227.248.225", 16,16, 16, args['rows'], "parallel", ""),
    ("54.224.3.74", 16,16, 16, args['rows'], "parallel", ""),
    ("100.25.2.85", 16,16, 16, args['rows'], "parallel", ""),
    ("3.84.28.20", 16,16, 16, args['rows'], "parallel", ""),
