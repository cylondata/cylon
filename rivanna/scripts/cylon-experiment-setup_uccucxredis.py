...
combination = [\
    ...
    ("54.84.214.80", 2,4, 8, "32G", args['rows'], "parallel", ""),
    ("3.238.116.229", 2,4, 8, "32G", args['rows'], "parallel", ""),
    ("54.157.181.17", 2,4, 8, "32G", args['rows'], "parallel", ""),
    ("34.228.29.43", 2,4, 8, "32G", args['rows'], "parallel", ""),
