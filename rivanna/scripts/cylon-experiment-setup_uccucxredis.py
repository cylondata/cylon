...
combination = [\
    ...
    ("54.84.214.80", 4,2, 8, args['rows'], "parallel", ""),
    ("3.238.116.229", 4,2, 8, args['rows'], "parallel", ""),
    ("54.157.181.17", 4,2, 8, args['rows'], "parallel", ""),
    ("34.228.29.43", 4,2, 8, args['rows'], "parallel", ""),
